...
const contributors = [
  {
    name: 'Indrek Haav',
    href: 'https://github.com/IndrekHaav'
  }
];
...
const messages:IMessages = {
  ...
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n        Ehkki selle vormi täitmine on eelistatud, võid ka saata e-kirja aadressile bugs@budgetwithbuckets.com\n      ",
    translated: true,
    h: "05fPQ/cX0e4UXnYsbNTo8b6FUwq/WZ1URc7ixr6WlV8=",
  },
  "(Drop files or click)": {
    val: "(Lohista failid või klõpsa)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Kui soovid vastust)",
    translated: true,
  ...
  "A sync is already in progress": {
    val: "Sünkroonimine on juba käimas",
    translated: true,
  ...
  "Account and transactions deleted": {
    val: "Konto ja tehingud kustutatud",
    translated: true,
  ...
  "Account deleted completely": {
    val: "Konto täielikult kustutatud",
    translated: true,
  ...
  "Any other monthly bills you have?": {
    val: "On sul veel igakuiseid arveid?",
    translated: true,
    h: "rmA9D10bvYOVj3U4kE7U6jALpz7WpqBJTv6HZaI4T/M=",
  },
  "Application preferences": {
    val: "Programmi eelistused",
    translated: true,
  ...
  "Attached files are too large.": {
    val: "Lisatud failide maht on liiga suur.",
    translated: true,
  ...
  "Budget Specific Settings": {
    ...
    val: "Eelarve-spetsiifilised seadistused",
    translated: true,
  ...
  "Cancel sync": {
    val: "Katkesta sünkroonimine",
    translated: true,
    h: "8xFWyPShIifEhumOA/PeoTtccm5TTtbQmWFViIGcPQA=",
  },
  "Car Insurance": {
    val: "Liikluskindlustus",
    translated: true,
  ...
  "Click the \"Set mapping\" to continue.": {
    val: "Jätkamiseks klõpsa \"Seosta veerud\".",
    translated: true,
  ...
  "Connection corrupted. Please delete and re-create.": {
    ...
    val: "Ühenduse viga. Palun kustuta ja loo uuesti.",
    translated: true,
  ...
  "Create Backup and Start Over": {
    val: "Tee varukoopia ja alusta uuesti",
    translated: true,
  ...
  "Download Update": {
    val: "Laadi uuendus alla",
    translated: true,
    h: "OvekDBh71chOkbTXqPs/V/x0lNbpc668s4hyXRF5G+I=",
  },
  "Downloading update...": {
    val: "Uuenduse allalaadimine...",
    translated: true,
  ...
  "For Date Posted, you must also choose the date format.": {
    val: "Kuupäeva veeru jaoks peab valima ka kuupäevaformaadi.",
    translated: true,
  ...
  "Identify the data each column contains using the drop downs below.": {
    val: "Täpsusta rippmenüüde abil igas veerus sisalduvad andmed.",
    translated: true,
  ...
  "If multiple columns are selected for Amount, the first non-zero value will be used.  This is helpful if the CSV contains separate Credit and Debit columns.": {
    val: "Kui summa veergusid on valitud mitu, kasutatakse esimest nullist erinevat väärtust. Sellest on kasu juhul, kui deebet ja kreedit on eraldi veergudes.",
    translated: true,
  ...
  "Install and Relaunch Buckets": {
    val: "Paigalda ja taaskäivita Buckets",
    translated: true,
  ...
  "Need ideas for getting started?": {
    val: "Vajad alustamiseks inspiratsiooni?",
    translated: true,
  ...
  "Only select a column for Unique ID if you are sure it contains bank-assigned, unique transaction IDs.  Most CSVs will not have this field.": {
    val: "Unikaalse ID veerg vali ainult siis, kui oled kindel, et seal on panga poolt määratud unikaalne tehingu ID. Enamikes CSV failides seda ei ole.",
    translated: true,
  ...
  "Or click to download the new version manually.": {
    val: "Või klõpsa siin, et uus versioon käsitsi alla laadida.",
    translated: true,
  ...
  "Select the account these transactions belong to.": {
    val: "Vali konto, mille alla need tehingud importida.",
    translated: true,
  ...
  "Transactions to review": {
    val: "Ülevaatamise ootel tehingud",
    translated: true,
  ...
  "Using this tool can ruin your budget file.  Make a copy of your budget if you're worried.": {
    val: "Selle tööriista kasutamine võib su eelarve faili ära rikkuda. Kui muretsed, tee igaks juhuks varukoopia.",
    translated: true,
  ...
  "You must have at least one column each set to Amount, Memo and Date Posted.": {
    val: "Valitud peavad olema vähemalt summa, selgituse ja kuupäeva veerud.",
    translated: true,
    h: "k5NuGeKNgPfZs7xUbwp5PgfPr6dosV0ZTVxAnphHH6E=",
  },
  "Your email address:": {
    val: "Sinu e-posti aadress:",
    translated: true,
  ...
  "account-bal-diff-1": {
    val: "Jooksev saldo ei klapi viimati sünkroonitud saldoga. Võimalikud põhjused:",
    translated: true,
    h: "9KaivrLeSKn8ROgvad6S9iE9NAz0BZRwQh3/ufRahVA=",
  },
  "account-bal-diff-fix-1": {
    /* 'Buckets' refers to the application name */
    val: "Pank teatas saldo tuleviku seisuga. Parandamiseks oota, kuni kõik tehingud on Bucketsisse jõudnud.",
    translated: true,
    h: "CRYYgg8YHspvP5KI3HGvyzlrOhxZf4rrjjUQbmL6Z7Q=",
  },
  "account-bal-diff-fix-2": {
    /* 'Buckets' refers to the application name. */
    val: "Mõni tehing on Bucketsist puudu.",
    translated: true,
  ...
  "bucket.transfer.help": {
    val: "Ülekanne on raha liigutamine ühelt kontolt teisele. Kui tehing ei ole sissetulek või väljaminek, on see tõenäoliselt ülekanne.",
    translated: true,
  ...
  "debt-payment-bucket-name": {
    ...
    val: (account_name:string) => `${account_name} tagasimakse`,
    translated: true,
  ...
  "edit.mapping": {
    val: (onClick) => {
          return <span>Või <a href="#" onClick={onClick}>muuda veergude seoseid</a>.</span>
        },
    translated: true,
  ...
  "error-detail": {
    val: "Kui seda viga tekib korduvalt, palun teavita veast või vestle meiega.",
    translated: true,
    h: "10Kk29tlHpBnhcTf7RRMfq1OZPGZgvPPguRlInaLNoY=",
  },
  "getting-started-link": {
    val: (clickhandler) => {
          return <span>Esimene kord Bucketsit kasutada? Vaata <a href="#" onClick={clickhandler}>videojuhendeid</a>.</span>
        },
    translated: true,
  ...
  "match-count": {
    val: (target_match:number, total_matches:number) => {
        return `${target_match} ${total_matches}-st`;
      },
    translated: true,
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} seisuga {date}</span>
                },
    translated: true,
  ...
  "nag-message": {
    val: () => `Kasutad registreerimata prooviversiooni, ja ehkki prooviperioodil pole piirangut, tuleb püsivaks kasutuseks litsents osta.

Kas soovid nüüd litsentsi osta?`,
    translated: true,
  ...
  "simplefin-connect-intro": {
    val: "Ühendumiseks tee järgnevad sammud:",
    translated: true,
    h: "421gz/BziKZhsIy2YKRFNtwoqPcbQ7uhFZWWfd6ReBg=",
  },
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Hangi {mklink('SimpleFIN Bridge')} abil SimpleFIN token</span>
            },
    translated: true,
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Seejärel kopeeri oma SimpleFIN token siia:",
    translated: true,
  ...
  "sync-symbol help": {
    val: "See sümbol tähistab imporditud või sünkroonitud tehingut",
    translated: true,
    h: "S3tDRls+AJYj6f8jSNSCa1FVyNY+ngn6Db1EQJ3dpLE=",
  },
  "sync.toast.syncing": {
    val: (start: string, end: string) => {
        return `Sünkroonin tehinguid alates ${start} kuni ${end}`;
      },
    translated: true,
  ...
  "toast.updated-trans": {
    val: count => `Uuendatud/lisatud ${count} tehingut`,
    translated: true,
    h: "bBKDE3rQIV5P80cYEL6mkLmIvgxjzVHCIf3aFa+KtmU=",
  },
  "trans-created-outofview": {
    val: (month: string) => {
              return <span>Tehing lisatud kuusse {month} </span>;
            },
    translated: true,
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Kanna kontolt {dropdown}</span>
              },
    translated: true,
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Kanna kontole {dropdown}</span>
              },
    translated: true,
  ...
  "version-available": {
    val: (newv:string) => `Versioon ${newv} on saadaval.`,
    translated: true,
